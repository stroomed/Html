		...
		<div class="inner">
                    <div id="centrar">
                         <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                             ...
                             <% for(detallesventa vent: listadoDetalles){ %>
                                     <tr>

                                             <td align='right' valign='top'><%= vent.getVentCodigo() %></td>
                                             <td align='right' valign='top'><%= vent.getDetventaItem()%></td>
                                             <td align='right' valign='top'><%= vent.getProdCodigo() %></td>
                                             <td align='right' valign='top'><%= vent.getDetventaCantidad() %></td>
                                             <td align='right' valign='top'><%= vent.getDetventaSubtotal() %></td>
                                     </tr>
                             <%} %>
                     </table>
                    </div>
